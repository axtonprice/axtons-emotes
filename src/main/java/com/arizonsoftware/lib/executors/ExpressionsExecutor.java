...
import com.arizonsoftware.lib.handlers.ExpressionsHandler;
...
public class ExpressionsExecutor implements CommandExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        ExpressionsHandler emote = new ExpressionsHandler();
        ...
        String globalMessage = Configuration.getString("commands.yml", "commands." + command.getLabel() + ".messages.global");
        ...
        globalMessage = placeholders.replaceString(globalMessage, randomResult);
        ...
        Debugging.log(this.getClass().getSimpleName() + "/onCommand", "Fetched globalMessage: " + globalMessage);

        // Set emote data
        emote.setResponses(playerMessage, globalMessage);
